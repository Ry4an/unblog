...
.. image:: http://ry4an.org/unblog/static/attachments/demo-security-groups.png
   :width: 572px
   :height: 299px
...
.. _provided tarball: http://ry4an.org/unblog/static/attachments/ec2-security-group-tools.tar.gz
